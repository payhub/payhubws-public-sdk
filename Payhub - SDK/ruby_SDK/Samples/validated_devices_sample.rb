...
response = transaction.getValidatedDevices

if response.errors==nil
  puts response.inspect
	response.enforce_device_validation=false
	transaction.patchValidatedDevices(response)
	response2 = transaction.getValidatedDevices
