...
public class WebHookConfigSample {
	...
	public static void main(String[] args) throws IOException {
				 ...
				 */
		         ...
		         try {
					WebhookConfiguration wc = new WebhookConfiguration();
					wc.setVirtualHub(false);
					transaction.patchWebhookConfiguration(wc);
					WebhookConfiguration webhookConfiguration = transaction.getWebhookConfiguration(); 
					System.out.println(webhookConfiguration.toString());
